...
function Foglalasaim() {
  ...
  if (loading)
    return <div className="loading-page">Foglalások betöltése...</div>;
          ...
          <div className="bookings-list">
            {bookings.map((booking) => (
              ...
              >
                ...
                <p>
                  <strong>Időpont:</strong> {booking.startTime} -{" "}
                  {booking.endTime}
                </p>
              </div>
            ))}
          ...
          <div className="booking-details-panel">
            {selectedBooking ? (
              <div className="b-details-card">
                ...
                <hr />
                <p>
                  <strong>Asztal:</strong> {selectedBooking.tableName}
                </p>
                <p>
                  <strong>Időpont:</strong> {selectedBooking.date} |{" "}
                  {selectedBooking.startTime} - {selectedBooking.endTime}
                </p>
                <p>
                  <strong>Foglaló neve:</strong> {selectedBooking.name}
                </p>
                <p>
                  <strong>Email:</strong> {selectedBooking.email}
                </p>
                <p>
                  <strong>Telefon:</strong> {selectedBooking.phone}
                </p>
                <p>
                  <strong>Létszám:</strong> {selectedBooking.headcount} fő
                </p>
                {selectedBooking.notes && (
                  <p>
                    <strong>Megjegyzés:</strong> {selectedBooking.notes}
                  </p>
                )}
                <p>
              ...
              <div className="details-placeholder">
                Válassz ki egy foglalást a listából a részletek megtekintéséhez!
              </div>
            )}
          </div>
        </div>
