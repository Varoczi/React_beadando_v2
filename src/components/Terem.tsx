...
function Terem({ tables, roomSize, selectedTableId, onSelectTable, onSizeChange, onRoomClick, isPlacementMode, conflictedTableIds, onDragStart, onDragMove, onDragEnd, draggingId }: RoomProps) {
      ...
      <div className="room-controls">
        <label>
          ...
          <input 
            ...
            onChange={(e) => onSizeChange(Number(e.target.value), roomSize.height)} 
          />
        </label>
        <label>
          Magasság: 
          <input 
            ...
            onChange={(e) => onSizeChange(roomSize.width, Number(e.target.value))} 
          />
        </label>
      </div>
